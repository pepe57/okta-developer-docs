...
This guide provides an overview of the Express Submission workflow to submit Express Configuration functionality for Auth0-enabled SaaS apps that contain OIDC, Universal Logout, and SCIM integration types to the Okta Integration Network (OIN) using the OIN Wizard.
...
* Submit new OIN integrations or update existing ones using Express Configuration
...
Okta provides you with a seamless experience to integrate and submit Express Configuration functionality in your Auth0-enabled app for publication in the Okta Integration Network (OIN). If your app uses Auth0 as the Service Provider for SSO (SAML and OIDC, or OIDC only), Universal Logout, or SCIM provisioning, you can use Express Submission to accelerate your Express Configuration functionality submission into the OIN. This submission flow automates the exchange of technical metadata between your Auth0 tenant and the OIN Wizard.
...
4. Click **Add integration details** to navigate to the Integration details page.
...
8. Paste the information you copied from the Auth0 dashboard into the **Express Configuration information** field, and click **Continue**.
...
> **Note**: If you exited the setup after providing the Express Configuration information, you can return to your submission to continue. In the Okta Admin Console, go to **Applications** > **Applications** > **Your OIN Integrations**. Select your draft integration, and then navigate to **Configure your integration** to download the PEM file again.
...
6. Click **Add integration details** to navigate to the Integration details page.
...
9. Click **Reconfigure**.
10. Paste the information you copied from the Auth0 dashboard into the **Express Configuration information** field, and click **Finish**.
